...
struct AddFoodSheet: View {
                ...
                Section {
                    VStack(alignment: .leading, spacing: 10) {
                        if !showAIAssist {
                            ...
                            if !canUseAI {
                                Text("Add your key in Config to enable AI macro estimates.")
                                    .font(.caption2)
                                    .foregroundStyle(.red)
                            }
                        }
    ...
    func refreshSearchHistoryEntries() {
        ...
        // discarding the bulk of them in memory. localizedStandardContains is case-
        // and diacritic-insensitive, matching the in-memory narrowing in memorySuggestions.
